...
Во второй главе [The hero editor]() при реализации live редактирования мы использовали метод `this.update` в action `setHeroName`. Пришло время понять откуда метод взялся и с чем связан.

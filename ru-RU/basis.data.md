...
basis.data.SUBSCRIPTION.add(
  ...
  // хендлер, отслеживающий изменения свойства, ссылающегося (?FIXME кто ссылается?)

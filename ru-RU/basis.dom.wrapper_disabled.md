...
В модуле `basis.ui` уже определены биндинги `disabled` и `enabled`, в их описании нет необходимости. Здесь приведен их описание в качестве примера, как можно использовать доступность в биндингах.
